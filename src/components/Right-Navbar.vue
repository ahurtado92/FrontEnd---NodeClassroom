    ...
    data () {
      return {
        ...
        items: [
          ...
          { title: 'Franjas', icon: 'calendar_view_month', path: 'intervals', conditions: 'estaActivo && isAdmin'  },
          { title: 'Periodos', icon: 'calendar_view_week', path: 'periods', conditions: 'estaActivo && isAdmin'  },
          { title: 'Asignaturas', icon: 'assignment_turned_in', path: 'subjects', conditions: 'estaActivo && isAdmin'  },
          { title: 'CSV', icon: 'file_present', path: 'csvform', conditions: 'estaActivo && isAdmin'  },
          { title: 'Search', icon: 'find_in_page', path: 'search', conditions: 'estaActivo && isAdmin'  },
        ],
        uname: null,
        unm: null,
      }
